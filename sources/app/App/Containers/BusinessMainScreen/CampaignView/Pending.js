...
import PendingCom from 'App/Containers/BusinessMainScreen/CampaignView/Pending/PendingCom'
        ...
        <ScrollView
          ...
          <FlatList
            ...
            renderItem={({item, index}) => (
              <PendingCom item={item} index={index} onPressPromotion={this.onPressPromotion} />
            )}
            horizontal={false}
          />
        </ScrollView>
