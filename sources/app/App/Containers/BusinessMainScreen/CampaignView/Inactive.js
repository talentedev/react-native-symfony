...
import InactiveCom from 'App/Containers/BusinessMainScreen/CampaignView/Inactive/InactiveCom'
...
export default class Inactive extends Component {
  ...
  //     if (dataItem) {
  //       this.setState({ book: this.props.dataItem })
  //     }
  //   }

  onReloadPromotion = (index) => {
    console.log('Reload Promotion : ', index)
  ...
  onPressPromotion = (item, index) => {
    console.log('onPressPromotion : ', index)
  ...
  //     console.log('getDerivedStateFromProps next tab ', nextProps.dataItem)
  //     console.log('getDerivedStateFromProps prev', prevState)
  //     if (nextProps.dataItem !== prevState.dataItem) {
  //       return { book: nextProps.dataItem }
  //     }
  //   }
        ...
        <ScrollView
          ...
          <FlatList
            ...
            renderItem={({item, index}) => (
              <InactiveCom item={item} index={index} onPressPromotion={this.onPressPromotion} />
            )}
            horizontal={false}
          />
        </ScrollView>
