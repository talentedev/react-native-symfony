...
import {Style} from './InactiveStyle'
...
export default class InactiveCom extends Component {
  constructor(props) {
    super(props)
      ...
      <SafeAreaView style={Style.referView}>
        <TouchableOpacity
          ...
          <View style={Style.expireView}>
            ...
            {itemData.endDate ? (
              <Text style={Style.expireText}>{translate('expiresOn') + ' ' + dateEnd[0]}</Text>
            ) : (
